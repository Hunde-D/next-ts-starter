...
export default function Home() {
  return (
    <div className="flex-col-start min-h-screen items-center justify-items-center gap-16 p-8 pb-20 font-[family-name:var(--font-geist-sans)] sm:p-20">
      <div className="row-start-2 mt-10 flex flex-col items-center gap-8 sm:items-start">
        <Image
